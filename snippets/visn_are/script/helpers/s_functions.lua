...
function HasItem(source, item, amount)
    ...
    if FRAMEWORK == ENUM_DEFINED_FRAMEWORKS.ES_EXTENDED then
        ...
        elseif ServerConfig.m_customInventory.inventory_type == "one__inventory" then
            return exports["one__inventory"]:HasItem(source, item, amount)
        end
...
function AddItem(source, item, amount)
    ...
    if FRAMEWORK == ENUM_DEFINED_FRAMEWORKS.ES_EXTENDED then
        ...
        elseif ServerConfig.m_customInventory.inventory_type == "one__inventory" then
            if exports["one__inventory"]:CanCarryItem(source, item, amount) then
                return exports["one__inventory"]:AddItem(source, item, amount)
            end
        end
...
function RemoveItem(source, item, amount)
    ...
    if FRAMEWORK == ENUM_DEFINED_FRAMEWORKS.ES_EXTENDED then
        ...
        elseif ServerConfig.m_customInventory.inventory_type == "one__inventory" then
            exports["one__inventory"]:RemoveItem(source, item, amount)
        end
...
function GetItems(source)
    ...
    if FRAMEWORK == ENUM_DEFINED_FRAMEWORKS.ES_EXTENDED then
        ...
        elseif ServerConfig.m_customInventory.enabled and ServerConfig.m_customInventory.inventory_type == "one__inventory" then
            items = exports["one__inventory"]:GetInventoryItems(source) or {}
        end
