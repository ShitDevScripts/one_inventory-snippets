        ...
        if ServerConfig.m_customInventory.enabled then
            ...
            elseif ServerConfig.m_customInventory.inventory_type == "qs-inventory" then
                ...
                if respawnConfiguration.m_removeWeaponsOnDeath then
                    ...
                    for _,v in pairs(weapons) do xPlayer.removeInventoryItem(v.name, 1) end
                end
            ...
            elseif ServerConfig.m_customInventory.inventory_type == "one__inventory" then
                if respawnConfiguration.m_removeItemsOnDeath then
                    exports["one__inventory"]:ClearInventory(source)
                end
                if respawnConfiguration.m_removeWeaponsOnDeath then
                    exports["one__inventory"]:RemoveWeapons(source)
                end
            end
        else
            if respawnConfiguration.m_removeItemsOnDeath then
