...
function RemoveItem(xPlayer, item, amount)
    ...
    if Config.Inventory == 'one' and IsWeapon(item) then
        exports.one_inventory:RemoveWeapons(item, amount)
        return
    end
...
function GetItemLabel(item)
    ...
    if Config.Inventory == 'one' then
        return exports.one_inventory:GetItemDefinition(item)?.label or item
    end
