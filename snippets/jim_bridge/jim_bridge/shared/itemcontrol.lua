...
local function registerOneInvUseHook()
    ...
    -- Wait for one_inventory to be fully initialized before registering hooks
    ...
    if success then
        ...
        debugPrint("^6Bridge^7: ^1Failed to register ^3one_inventory^1 use hook (not ready yet)^7")
        oneInvUseHookRegistered = false
    end
end
